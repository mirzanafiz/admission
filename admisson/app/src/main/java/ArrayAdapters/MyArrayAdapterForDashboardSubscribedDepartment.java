...
public class MyArrayAdapterForDashboardSubscribedDepartment extends ArrayAdapter<subscribeInfo> {

    public MyArrayAdapterForDashboardSubscribedDepartment(Context context, ArrayList<subscribeInfo> si)
    {
        super(context, 0,si);
    }
